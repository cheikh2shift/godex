...
echo ""
echo "  docker compose -f ${INSTALL_DIR}/docker-compose.yml up -d && docker attach godex"
echo ""
echo "  # Add this alias to ~/.bashrc or ~/.zshrc:"
echo "  alias godex='docker compose -f ${INSTALL_DIR}/docker-compose.yml up -d && docker attach godex'"
echo ""
